...
| ---------------------------------------------- | ----------------------------------------- |
| `.claude/skills/hyperframes/`                  | `skills/hyperframes/`                     |
| `.claude/skills/hyperframes-cli/`              | `skills/hyperframes-cli/`                 |
| `.claude/skills/hyperframes-registry/`         | `skills/hyperframes-registry/`            |
| `.claude/skills/website-to-hyperframes/`       | `skills/website-to-hyperframes/`          |

The `gsap` upstream skill is NOT re-vendored — OpenMontage already ships its
own GSAP skill family under `.claude/skills/gsap*/`.
...
rm -rf .claude/skills/hyperframes .claude/skills/hyperframes-cli \
       .claude/skills/hyperframes-registry .claude/skills/website-to-hyperframes
cp -r C:/Users/ishan/Documents/hyperframes/skills/hyperframes          .claude/skills/
cp -r C:/Users/ishan/Documents/hyperframes/skills/hyperframes-cli      .claude/skills/
cp -r C:/Users/ishan/Documents/hyperframes/skills/hyperframes-registry .claude/skills/
cp -r C:/Users/ishan/Documents/hyperframes/skills/website-to-hyperframes .claude/skills/
