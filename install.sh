...
echo ""
echo "  2. In your MAIN agent project (a different folder):"
echo "       /plugin add $PLUGIN_ROOT"
echo ""
echo "  3. From the main agent, invoke the sub-agent:"
echo "       \"Use @video-production-agent to produce a 30s short for MD-905.\""
echo ""
